...
public class BeijingDiaobanRouteB extends BaseDiaobanDrawing {
        ...
        if (drawInfo.routeInfo() != null) {
            ...
            for (int i = 0; i < drawInfo.routeInfo().drawStations.size(); i++) {
                ...
                if (thisStn.transInfo != null && thisStn.transInfo.size() > 0) {
                    int[] clipX, clipY;
                    if (nameOnTop) {
                        clipX = new int[]{currentX - (int) (h * 0.03), currentX - (int) (h * 0.03), currentX,
                                currentX + (int) (h * 0.03), currentX + (int) (h * 0.03)};
                        clipY = new int[]{y + (int) (h * 0.5), y + (int) (h * 0.6), y + (int) (h * 0.625),
                                y + (int) (h * 0.6), y + (int) (h * 0.5)};
                    } else {
                        clipX = new int[]{currentX - (int) (h * 0.03), currentX - (int) (h * 0.03), currentX,
                                currentX + (int) (h * 0.03), currentX + (int) (h * 0.03)};
                        clipY = new int[]{y + (int) (h * 0.5), y + (int) (h * 0.4), y + (int) (h * 0.375),
                                y + (int) (h * 0.4), y + (int) (h * 0.5)};
                    }
                    ...
                    JsFunctions.jsDrawStrDl(g, fontBold, fontBold,
                            ...
                            currentX, nameOnTop ? y + (int) (h * 0.65) : y + (int) (h * 0.275), h * 0.075, 1, 1);
                ...
                if (i == drawInfo.index()) {
                    ...
                    g.setColor(routeColor);
                    g.fillRoundRect(currentX - strWidth / 2 - (int) (h * 0.0075),
                            y + (int) (h * (nameOnTop ? 0.225 : 0.575)),
                            strWidth + (int) (h * 0.015), (int) (h * 0.2), (int) (h * 0.05), (int) (h * 0.05));
