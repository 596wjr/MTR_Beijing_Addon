...
public class BeijingDiaobanC3StationB extends BaseDiaobanDrawing {
    ...
    public void draw(GraphicsTexture gt, List<RouteSelectInfo> routes,
        ...
        if (drawInfo.routeInfo() != null) {
            ...
            if (drawInfo.index() == drawInfo.routeInfo().drawStations.size() - 1) {
                ...
                switch (headAlign) {
                    ...
                    case 1:
                        ...
                        g.fillOval(widthPercent(x, w, 0.5) - strWidth / 2 - (int) (h * 0.3),
                                heightPercent(y, h, 0.25), (int) (h * 0.5), (int) (h * 0.5));
                    ...
                    case 2:
                        g.setColor(Color.WHITE);
                        g.fillOval(widthPercent(x, w, 0.5) + strWidth / 2 - (int) (h * 0.25),
                                heightPercent(y, h, 0.25), (int) (h * 0.5), (int) (h * 0.5));
